...
\textcolor{red}{Finite-singular map}
...
\begin{lemma}
Assume $R$ is principal and let $\FF$ be a cartesian Selmer structure such that $\chi(\FF)\geq 1$. Assume that 
...
\[\xymatrix{R\ar[r] & H^1_{\GG}(K,T)^\vee\ar[r]^{\loc_\ell} & \ar[r] H^1_{\GG/\FF}(K_\ell,T)^\vee  \ar[r]^{\cong} &R}\]
