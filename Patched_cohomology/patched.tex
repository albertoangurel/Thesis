...
\begin{definition}
Let $T$ be an $R[[G_K]]$-module and let $\ku$ be an ultraprime represented by the sequence $(\ell_n)$. The local patched cohomology group is defined as
\[\bH^i(K_\ku,T):=\bH^i((G_{K_{\ell_n}}),T)\]
\end{definition}
